...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-cowplot-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-cowplot-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-cowplot-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-cowplot-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-cowplot-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-cowplot-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-cowplot/badges/version.svg)](https://anaconda.org/conda-forge/r-cowplot)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-cowplot/badges/downloads.svg)](https://anaconda.org/conda-forge/r-cowplot)
